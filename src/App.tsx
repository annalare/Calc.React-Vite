    ...
    <div className="background-calc">
      <div className="calc">
        ...
        <table>
          <tr>
            <td>
              <button onClick={() => cleanScreen()} className="calc-button">
                C
              </button>
            </td>
            <td>
          ...
          <tr>
            ...
            <td rowSpan={2}>
              <button className="calc-button equals">=</button>
            </td>
          </tr>
          <tr>
            <td colSpan={2}>
              <button
                onClick={() => addDigitScreen("0")}
